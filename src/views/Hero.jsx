  ...
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        ...
        <SVG icon="hexa" width={48} stroke={colors.black} left="60%" top="70%" />
        <SVG icon="box" width={6} fill={colors.black} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors.black} left="80%" top="10%" />
        <SVG icon="triangle" width={12} stroke={colors.black} left="90%" top="50%" />
        <SVG icon="circle" width={16} fill={colors.black} left="70%" top="90%" />
        <SVG icon="triangle" width={16} stroke={colors['grey-darkest']} left="30%" top="65%" />
        <SVG icon="cross" width={16} stroke={colors.black} left="28%" top="15%" />
      ...
      <SVG icon="box" hiddenMobile width={64} fill={colors.black} left="5%" top="90%" />
